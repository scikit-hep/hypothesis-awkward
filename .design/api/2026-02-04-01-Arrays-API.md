...
>   [max-length-api](2026-02-23-01-Max-length-API.md) for details.
>
...
>   size). See [max-size-api](2026-03-29-01-Max-size-API.md).
...
>   See [min-length-api](2026-04-24-01-Min-length-API.md).
...
From the [UX research](./../research/2026-01-21-02-UX-interview-01.md),
[type system research](./../research/2026-01-21-01-Type-system-research.md), and
...
See [contents-tree-builder](../impl/2026-02-17-01-Contents-tree-builder.md) for
...
[contents-tree-builder](../impl/2026-02-17-01-Contents-tree-builder.md)). When
...
4. ~~Add string/bytestring support (`allow_string`, `allow_bytestring`)~~ ✓ —
   see [string-bytestring-api](./../api/2026-02-13-01-String-bytestring-API.md)
