...
is a fixed lens that calibrates its expectations to the page's purpose and
Diátaxis quadrant — judging the page against what a page of that kind should do,
not a universal checklist. A page is written well when the personas it serves
find it relevant and useful, and the personas it does not serve can tell early
in the page that it is not for them, while still seeing that it is useful to
other readers. See
[`2026-06-17-01-README-intro-persona-review.md`](./2026-06-17-01-README-intro-persona-review.md).
