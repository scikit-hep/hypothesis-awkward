...
synthesize** (accuracy beats style). This loop is operationalized as the
...
reviews every page, and each also rates how relevant the page is to them. A page
is written well when the personas it serves find it relevant and useful, and the
