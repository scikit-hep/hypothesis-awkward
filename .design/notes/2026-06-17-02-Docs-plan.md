...
undeclared cross-quadrant content is bleed. Before reporting, each persona
self-checks alignment and routes any out-of-quadrant ask or on-page bleed to the
page that owns that quadrant, rather than reporting it as a defect of this page.
A page is written well when the personas it serves find it relevant and useful,
and the personas it does not serve can tell early in the page that it is not for
them, while still seeing that it is useful to other readers. See
[`2026-06-17-01-README-intro-persona-review.md`](./2026-06-17-01-README-intro-persona-review.md).
