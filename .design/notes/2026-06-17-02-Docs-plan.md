...
[`diataxis-review.md`](../../.claude/skills/persona-review/references/diataxis-review.md)
...
[`2026-06-17-01-README-intro-persona-review.md`](./2026-06-17-01-README-intro-persona-review.md).
Each persona is a head file in `.claude/personas/` that the `persona-review`
skill (invoked by `write-docs-page`) hands to a generic reviewer subagent,
launched in parallel; the table below is the design rationale.
